...
Fork the project [on GitHub](https://github.com/geut/splitter) and check out your copy locally.

```bash
$ git clone git@github.com:username/splitter.git
$ cd splitter
$ npm install
$ git remote add upstream git://github.com/geut/splitter.git
```
